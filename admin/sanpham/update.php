...
<div class="row2">
    ...
    <div class="row2 form_content ">
        <form action="sanpham.php?act=updatesp" method="POST" enctype="multipart/form-data">
        ...
        <div class="row mb10 ">
            ...
            <a href="sanpham.php?act=listsp">  <input  class="mr20" type="button" value="DANH SÁCH"></a>
        </div>
        <?php
