    ...
    <div class="row2 form_content ">
        <form action="#" method="POST">
            <div class="row2 mb10 formds_loai">
                <form action="sanpham.php?act=listsp" method="post">
                ...
                <table>
                    ...
                    foreach ($listsanpham as $sanpham) {
                        ...
                        $suasp = "sanpham.php?act=suasp&idsp=" . $id;
                        $hard_delete = "sanpham.php?act=hard_delete&idsp=" . $id;
                        $soft_delete = "sanpham.php?act=soft_delete&idsp=" . $id;
                        if (is_file($hinhpath)) {
            ...
            <div class="row mb10 ">
                ...
                <a href="sanpham.php?act=addsp"> <input class="mr20" type="button" value="NHẬP THÊM"></a>
            </div>
        </form>
    </div>
</div>
